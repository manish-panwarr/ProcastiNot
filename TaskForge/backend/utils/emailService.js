...
<body>
    <table class="outer-wrapper" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f4f7fb; padding:12px;">
        <tr>
            <td align="center">
                <table class="container" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:720px; background:#ffffff; border-radius:16px; overflow:hidden; border:1px solid #e5e7eb; box-shadow:0 12px 40px rgba(15,23,42,0.08);">
                    <tr>
                        <td>
                            <img src="https://res.cloudinary.com/dsrtgoxkj/image/upload/v1783771841/ChatGPT_Image_Jul_11_2026_05_40_17_PM_fzmrmb.png" alt="TaskForge" width="720" style="width:100%; display:block;" />
                        </td>
                    </tr>
                    <tr>
                        <td class="header" style="background:linear-gradient(135deg, ${headerColor} 0%, #3b82f6 100%); padding:40px 32px; text-align:center;">
                            <h1 class="heading" style="margin:0; color:#ffffff; font-size:25px; font-weight:700; line-height:1.2; letter-spacing:-0.5px;">
                                ${headerText}
                            </h1>
                            <p class="subheading" style="margin:14px auto 0; max-width:500px; color:rgba(255,255,255,0.92); font-size:15px; line-height:1.7;">
                               A project update requires your attention. Review the details below.
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td class="content" style="padding:8px 1px; font-size:14px; line-height:1.8; color:#334155;">
                            ${body}
                        </td>
                    </tr>
                    <tr>
                        <td class="divider-padding" style="padding:0 36px;">
                            <div style="height:1px; background:#e2e8f0;"></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="footer" style="background:#f8fafc; padding:24px; text-align:center;">
                            <p style="margin:0; font-size:12px; line-height:1.7; color:#64748b;">
                                This email was sent because you are a registered member of <a href="${appUrl}" style="color:${headerColor}; text-decoration:none; font-weight:600;">TaskForge</a>.
                            </p>
