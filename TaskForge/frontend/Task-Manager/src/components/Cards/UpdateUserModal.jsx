...
const UpdateUserModal = ({ isOpen, onClose, user, onUpdate }) => {
    ...
    useEffect(() => {
        if (user) {
            ...
            if (userDept) {
                if (predefinedDepartments.includes(userDept)) {
                    setDepartment(userDept);
                    setCustomDepartment("");
                } else {
                    setDepartment("Other");
                    setCustomDepartment(userDept);
                }
            } else {
                setDepartment("");
                setCustomDepartment("");
        ...
        >
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    {department === "Other" && (
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Custom Department</label>
                            <input
                                type="text"
