...
export const NotificationProvider = ({ children }) => {
    ...
    //@desc : Re-fetch when socket reconnects (catches missed notifications during disconnect gap)
    useEffect(() => {
    ...
    //@desc : Real-time notification listener
    useEffect(() => {
        if (!socket || !user) return;

        const handleNewNotification = (notification) => {
            setNotifications((prev) => {
                // @desc : Prevent duplicate notifications
