...
//@desc : View task details page for user
//@route: /user/task-details/:id
//@access: Private
//@return : JSX
const ViewTaskDetails = () => {
    ...
    //@desc : openfile open in new tab
    const handleLinkClick = (link) => {
        window.open(link, "_blank");
    };

    //@desc : Get file icon based on file type
