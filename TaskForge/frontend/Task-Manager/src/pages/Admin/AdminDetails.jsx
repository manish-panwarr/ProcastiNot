...
//@desc : Admin details page for admin
const AdminDetails = () => {
    const { id } = useParams();
    ...
    if (loading) {
        return (
            <DashboardLayout activeMenu="Admins" className="h-full">
